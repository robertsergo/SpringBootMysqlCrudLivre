...
import com.example.SpringBootMysqlCrudLivre.service.LivreService;
...
public class LivreController {
   ...
   @RequestMapping("/mesLivres/{id}")
    public String obtenirMesLivres(@PathVariable("id") Long id){
        ...
        MesLivres ml = new MesLivres(l.getId(), l.getTitle(), l.getAuteur(), l.getEdition(), l.getNbPage(), l.getPrix());
